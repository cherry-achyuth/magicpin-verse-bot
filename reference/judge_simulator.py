...
# Constants
TIMEOUT_LLM = 45
DATASET_DIR = Path(__file__).parent / "dataset" if (Path(__file__).parent / "dataset").exists() else Path(__file__).parent.parent / "dataset"
...
class GroqProvider(LLMProvider):
    def __init__(self, api_key: str, model: str = ""):
        self.api_key = api_key
        self.model = model or "groq/compound-mini"
